			...
			<ul class="gallery">
				...
				<?php
					...
					if ($result->num_rows > 0){
						...
						$query_2 = "SELECT * from images where id = '".$row['id']."'";
						$result_2 = $conn->query($query_2);
						$row_2 = $result_2->fetch_assoc();
						echo 
							"<li>
							<a href='".$row_2['path']."'><img class='top' src='".$row_2['path']."' width='260' height='200' 
							title='<a href=\"/image.php?id=".$row_2['id']."\" >".$row_2['title']."</a> 
							Your bid: ".$row['bid']."'	alt='alt_text' /></a>
							<h3 style=\"font-size:18px;background-color: #00ff00;\">".$row_2['title']."</h3>
